...
const ServicesSection = () => {
    const services = [
        { number: '01', title: 'IoT Systems', link: '#iot' },
        { number: '02', title: 'Software Development', link: '#software' },
        { number: '03', title: 'Electronic Engineering', link: '#engineering' },
        { number: '04', title: 'Industrial Automation', link: '#automation' }
    ];
            ...
            <div className="cybage-services-container">
                ...
                <div className="cybage-services-content">
                    <div className="cybage-services-left">
                        <h2 className="cybage-services-heading">
                            Our <span className="cybage-highlight">Services</span>
                        </h2>
                        <p className="cybage-services-subtitle">
                        ...
                        <div className="cybage-services-list">
                            {services.map((service, index) => (
                                <a href={service.link} key={index} className="cybage-service-item">
                    ...
                    <div className="cybage-services-image">
                        <img
                            ...
                            className="cybage-main-image"
                        />

                        <div className="cybage-blue-sketch">
                    ...
                    <div className="cybage-services-right">
                        <div className="cybage-cta-card cybage-cta-transparent">
                        ...
                        <div className="cybage-cta-card cybage-cta-green">
